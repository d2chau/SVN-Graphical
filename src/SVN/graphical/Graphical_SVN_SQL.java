/**
 * File: Graphical_SVN_SQL.java
 * 
 * Description: This class's functionality is to get connection with the JDBC 
 * driver and connect to the mySQL server. Once a connection has been made, 
 * then it will begin to upload data to the mySQL server in batches to minimize
 * overhead. This class also checks to see if the information already exists
