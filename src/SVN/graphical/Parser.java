 ...
 * File: Parser.java
 * 
 * Description: This class's functionality is to go to the data file created, 
 * and are the data into projects. Once the file has been parsed, then it will
 * format lists of queries which will be run by the next class called
 * 
 * Author: David Chau
 * 
 */
...
class Parser{
  //An's file location
  //private String textFilePath = "C:\\Users\\An Nguyen\\Desktop\\";
  
  //David's file location
  private String textFilePath = "C:\\Users\\d2chau\\Desktop\\";
	private String textFileName = "all_output.txt";
